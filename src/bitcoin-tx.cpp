...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s havercoinnnn-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  havercoinnnn-tx [options] <hex-tx> [commands]  " + _("Update hex-enchavercoinininininin transaction") + "\n" +
              "  havercoinnnn-tx [options] -create [commands]   " + _("Create hex-enchavercoinininininin transaction") + "\n" +
              "\n";
