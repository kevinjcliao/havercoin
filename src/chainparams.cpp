...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.havercoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.havercointools.com", true);
        vSeeds.emplace_back("dnsseed.havercoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.havercointools.com", true);
        vSeeds.emplace_back("seed-b.havercoin.loshan.co.uk", true);
