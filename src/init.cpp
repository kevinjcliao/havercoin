...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/havercoin-project/havercoin>";
    const std::string URL_WEBSITE = "<https://havercoin.org>";
