...
#if defined(NDEBUG)
# error "havercoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "havercoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s HVC additional fees, %d delta bytes\n",
